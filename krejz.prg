...
PROCEDURE KRejZ()
   ...
   PRIVATE nOrgW2, nOrgW7, nOrgW12, nOrgW22
...
*             @  3,2 say 'ֽֽ'+chr(16)
            ...
            @  5, 29 GET znazwa PICTURE "@S40 "+repl('!',100) valid w1_3z().and.v1_3z()
            @  6, 29 GET zADRES PICTURE "@S40 " + repl( '!', 100 ) VALID v1_4z()
...
***************************************************
   ...
   CASE Left( LTrim( znumer ), 3 ) == 'KR-'
      ...
      RETURN .F.
   ENDCASE
   EwidSprawdzNrDok( 'REJZ', ident_fir, miesiac, znumer )
   *@  3,2 say '   '
   *@  4,2 say 'ֽֽ'+chr(16)
   RETURN .T.
