...
PROCEDURE Vat_718( _G, _M, _STR, _OU )
   ...
   PRIVATE KorKOL47, KorKOL48, zZwrRaVAT := 0, zAdrEMail
...
*        ColStd()
         ...
         @  3, 70 GET kordek PICTURE '!' WHEN wfkordek18( 3, 71 ) VALID vfkordek18( 3, 71 )
         IF zVATFORDR == '7D'
   ...
   *             endif
      ...
      CASE _OU == 'K'
         ...
         CASE 1
            SWITCH zVATFORDR
            CASE '7 '
               DeklarDrukuj( 'VAT7-18' )
               EXIT
            CASE '7K'
               DeklarDrukuj( 'VAT7K-12' )
               EXIT
            CASE '7D'
...
//         IF ValType( tresc_korekty_vat7 ) == "C"
            ...
            DO CASE
            CASE zVATFORDR == '7 '
               resdekl := edek_vat7_18( aDane )
               edekZapiszXml( resdekl, edeklaracja_plik, wys_edeklaracja, 'VAT7-18', kordek == 'K', Val( miesiac ) )
            CASE zVATFORDR == '7K'
               resdekl := edek_vat7k_12( aDane )
               edekZapiszXml( resdekl, edeklaracja_plik, wys_edeklaracja, 'VAT7K-12', kordek == 'K', Val( miesiac ) )
            CASE zVATFORDR == '7D'
