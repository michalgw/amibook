...
FUNCTION menuKonfigKsiega()
   ...
   PRIVATE zparam_ks5v, zparam_ks5d, zparam_kslp, zparam_ksnd, zparam_kskw
   ...
   @  4,42 say ' 1 - VAT: 50%                         '
   @  5,42 say '     Ksi©ga: Netto + 50% VAT          '
   @  6,42 say ' 2 - VAT: 50%                         '
   @  7,42 say '     Ksi©ga: 50% Netto + 50% VAT      '
   @  8,42 say 'ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ'
   @  9,42 say ' Obliczanie podstawy opodatkowania    '
   @ 10,42 say ' deklaracji VAT-7 (pole 43.)          '
   @ 11,42 say ' dla 50% VAT na pojazdy (1/2):        '
   @ 12,42 say ' 1 - 100%     2 - 50%                 '
   @ 13,42 say 'ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ'
   @ 14,42 say ' Sortowanie dokument¢w w ksi©dze      '
...
FUNCTION menuKonfigKsiegaPolKSKW()
   ...
   ENDIF
      IF !zparam_kskw$'TN'
         ...
         RETURN .F.
      ENDIF
   @ 22, 73 SAY iif(param_kskw == 'T', 'ak', 'ie')
   RETURN .T.
