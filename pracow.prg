...
@  4, 0 say '⁄ƒƒƒƒƒƒƒƒƒƒƒNazwiskoƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒImi© 1ƒƒƒƒ¬ƒƒƒƒImi© 2ƒƒƒƒ¬Statusƒ¬ƒPàecƒƒ¬Krø'
@  5, 0 say '≥                             ≥              ≥              ≥       ≥       ≥  ≥'
@  6, 0 say '≥                             ≥              ≥              ≥       ≥       ≥  ≥'
@  7, 0 say '≥                             ≥              ≥              ≥       ≥       ≥  ≥'
@  8, 0 say '≥                             ≥              ≥              ≥       ≥       ≥  ≥'
@  9, 0 say '≥                             ≥              ≥              ≥       ≥       ≥  ≥'
@ 10, 0 say '≥                             ≥              ≥              ≥       ≥       ≥  ≥'
@ 11, 0 say '√ƒ(       )ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒ¡ƒƒ¥'
...
FUNCTION PracDokidrozWhen()
   ...
   @ 17, 12 SAY '4 - URZ®DOWY DOKUMENT STWIERDZAJ§CY TOΩSAMOóè'
   @ 18, 12 SAY '8 - INNY RODZAJ IDENTYFIKACJI PODATKOWEJ'
   @ 19, 12 SAY '9 - INNY DOKUMENT POTWIERDZAJ§CY TOΩSAMOóè'
   SetColor( cKolorTmp )
   RETURN .T.
...
FUNCTION PracDokRodzajStr( cRodzaj )
   ...
   CASE cRodzaj == '4'
      cRodzajDokIdStr := 'URZ®DOWY DOKUMENT STWIERDZAJ§CY TOΩSAMOóè'
   CASE cRodzaj == '8'
      cRodzajDokIdStr := 'INNY RODZAJ IDENTYFIKACJI PODATKOWEJ'
   CASE cRodzaj == '9'
      cRodzajDokIdStr := 'INNY DOKUMENT POTWIERDZAJ§CY TOΩSAMOóè'
   OTHERWISE
      cRodzajDokIdStr := ''
   ENDCASE
