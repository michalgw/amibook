...
sprawdzVAT(10,faktury->DATAS)
      if faktury->DATAS<>ctod('    .  .  ')
         k55='Data sprzeda&_z.y-'+dtoc(faktury->DATAS)
*         k55='Data sprzeda&_z.y-'+substr(dtoc(faktury->DATAS),1,7)
      else
         k55='Data sprzeda&_z.y-'+strtran(param_rok+[.]+faktury->mc+[.]+faktury->dzien,' ','0')
...
//003 nowy warunek dla obslugi wydruku komentarza
      ...
      if zRACH='F'
         if nr_uzytk<>32
            mon_drk([ ]+space(25)+[                        F A K T U R A   V A T   Nr  ]+k6)
         else
      ...
      mon_drk([³                (us&_l.ugi)                ³     PKOB     ³  Ilo&_s.&_c. ³miary³   netto    ³    netto     %      podatku  ³   brutto   ³])
