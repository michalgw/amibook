...
*      mon_drk('Suma nale&_z.nych zaliczek od pocz&_a.tku roku............................'+tran(P94,dRPIC))
      ...
      mon_drk('')
      mon_drk('5.    NIP:'+dzial_g[5,1]+'         REGON:'+dzial_g[5,2])
      mon_drk('      '+padr(dzial_g[5,3],35)+'         '+alltrim(dzial_g[5,4]))
      mon_drk('Udzia&_l. w %                  Przych&_o.d       Koszty        Doch&_o.d        Strata')
      mon_drk('  '+tran(dzial_g[5,5],'999.99')+space(16)+tran(dzial_g[5,6],dRPICe)+' '+tran(dzial_g[5,7],dRPICe)+' '+tran(dzial_g[5,8],dRPIC)+'  '+tran(dzial_g[5,9],dRPIC))
      mon_drk('')
      mon_drk('6.    NIP:'+dzial_g[6,1]+'         REGON:'+dzial_g[6,2])
      mon_drk('      '+padr(dzial_g[6,3],35)+'         '+alltrim(dzial_g[6,4]))
      mon_drk('Udzia&_l. w %                  Przych&_o.d       Koszty        Doch&_o.d        Strata')
      mon_drk('  '+tran(dzial_g[6,5],'999.99')+space(16)+tran(dzial_g[6,6],dRPICe)+' '+tran(dzial_g[6,7],dRPICe)+' '+tran(dzial_g[6,8],dRPIC)+'  '+tran(dzial_g[6,9],dRPIC))
      mon_drk('')
