...
PROCEDURE Drukuj_DeklarXML( cPlikXML, cTypDeklaracji, cNrRef )
   ...
   CASE 'PIT4R-12'
      ...
      EXIT
   CASE 'PIT4R-13'
      hDane := DaneXML_PIT4Rw13( oDoc, cNrRef )
   ...
   CASE 'PIT8AR-12'
      ...
      EXIT
   CASE 'PIT8AR-13'
      hDane := DaneXML_PIT8ARw13( oDoc, cNrRef )
   ...
   CASE 'VAT9M-11'
      ...
      EXIT
   CASE 'VAT12-4'
      hDane := DaneXML_VAT12w4( oDoc, cNrRef )
      cPlikRap := 'frf\vat12_w4.frf'
      cOrdzuFrf := 'frf\ordzu_w3.frf'
      AAdd( aRaporty, { hDane, cPlikRap } )
      EXIT
   CASE 'VATUE-3'
   ...
   CASE 'IFT2-11'
   CASE 'IFT2R-11'
      hDane := DaneXML_IFT2w11( oDoc, cNrRef )
      cPlikRap := 'frf\ift2_w11.frf'
      AAdd( aRaporty, { hDane, cPlikRap } )
      EXIT
   CASE 'IFT2-12'
   CASE 'IFT2R-12'
      hDane := DaneXML_IFT2w12( oDoc, cNrRef )
   ...
   CASE 'JPKV7M-3'
   CASE 'JPKV7K-3'
      hDane := DaneXML_JPKV7w3( oDoc, cNrRef )
      IF ! hDane[ 'JestDeklaracja' ]
         cPlikRap := 'frf\jpkv7n_w3.frf'
         AAdd( aRaporty, { hDane, cPlikRap } )
      ENDIF
      IF hDane[ 'JestDeklaracja' ]
         cPlikRap := 'frf\jpkv7d_w3.frf'
         AAdd( aRaporty, { hDane, cPlikRap } )
      ENDIF
      IF hDane[ 'JestSprzedaz' ] .OR. hDane[ 'JestZakup' ]
         cPlikRap := 'frf\jpkv7j_w3.frf'
         AAdd( aRaporty, { hDane, cPlikRap } )
      ENDIF
      EXIT
   OTHERWISE
...
FUNCTION DaneXML_PIT4Rw13(oDoc, cNrRef, hNaglowek)
   LOCAL hPodmiot1, cTmp, hPozycje
   LOCAL hDane := hb_Hash()
   IF !HB_ISHASH( hNaglowek )
      hNaglowek := edekXmlNaglowek( oDoc )
   ...
   hDane['P_158_1'] := iif( xmlWartoscH( hPozycje, 'P_158' ) == '1', '1', '0' )
   hDane['P_158_2'] := iif( xmlWartoscH( hPozycje, 'P_158' ) == '2', '1', '0' )
   ...
   hDane['P_183'] := xmlWartoscH( hPozycje, 'P_183', '' )
   hDane['P_184'] := xmlWartoscH( hPozycje, 'P_184', '0' )
   hDane['P_185'] := xmlWartoscH( hPozycje, 'P_185', '0' )
   hDane['P_186'] := xmlWartoscH( hPozycje, 'P_186', '0' )
   hDane['P_187'] := xmlWartoscH( hPozycje, 'P_187', '0' )
   hDane['P_188'] := xmlWartoscH( hPozycje, 'P_188', '0' )
   hDane['P_189'] := xmlWartoscH( hPozycje, 'P_189', '0' )
   hDane['P_190'] := xmlWartoscH( hPozycje, 'P_190', '0' )
   hDane['P_191'] := xmlWartoscH( hPozycje, 'P_191', '0' )
   hDane['P_192'] := xmlWartoscH( hPozycje, 'P_192', '0' )
   hDane['P_193'] := xmlWartoscH( hPozycje, 'P_193', '0' )
   hDane['P_194'] := xmlWartoscH( hPozycje, 'P_194', '0' )
   hDane['P_195'] := xmlWartoscH( hPozycje, 'P_195', '0' )
...
FUNCTION DaneXML_PIT8ARw13(oDoc, cNrRef, hNaglowek)
   LOCAL hPodmiot1, cTmp, hPozycje
   LOCAL hDane := hb_Hash()
   IF !HB_ISHASH( hNaglowek )
      hNaglowek := edekXmlNaglowek( oDoc )
   ...
   hDane['P_440'] := sxml2num( xmlWartoscH( hPozycje, 'P_440' ) )
   hDane['P_441'] := sxml2num( xmlWartoscH( hPozycje, 'P_441' ) )
   hDane['P_442'] := sxml2num( xmlWartoscH( hPozycje, 'P_442' ) )
   hDane['P_443'] := sxml2num( xmlWartoscH( hPozycje, 'P_443' ) )
   hDane['P_444'] := sxml2num( xmlWartoscH( hPozycje, 'P_444' ) )
   hDane['P_445'] := sxml2num( xmlWartoscH( hPozycje, 'P_445' ) )
   hDane['P_446'] := sxml2num( xmlWartoscH( hPozycje, 'P_446' ) )
   hDane['P_447'] := sxml2num( xmlWartoscH( hPozycje, 'P_447' ) )
   hDane['P_448'] := sxml2num( xmlWartoscH( hPozycje, 'P_448' ) )
   hDane['P_449'] := sxml2num( xmlWartoscH( hPozycje, 'P_449' ) )
   hDane['P_450'] := sxml2num( xmlWartoscH( hPozycje, 'P_450' ) )
   hDane['P_451'] := sxml2num( xmlWartoscH( hPozycje, 'P_451' ) )
   hDane['P_452'] := sxml2num( xmlWartoscH( hPozycje, 'P_452' ) )
   hDane['P_453'] := sxml2num( xmlWartoscH( hPozycje, 'P_453' ) )
   hDane['P_454'] := sxml2num( xmlWartoscH( hPozycje, 'P_454' ) )
   hDane['P_455'] := sxml2num( xmlWartoscH( hPozycje, 'P_455' ) )
   hDane['P_456'] := sxml2num( xmlWartoscH( hPozycje, 'P_456' ) )
   hDane['P_457'] := sxml2num( xmlWartoscH( hPozycje, 'P_457' ) )
   hDane['P_458'] := sxml2num( xmlWartoscH( hPozycje, 'P_458' ) )
   hDane['P_459'] := sxml2num( xmlWartoscH( hPozycje, 'P_459' ) )
   hDane['P_460'] := sxml2num( xmlWartoscH( hPozycje, 'P_460' ) )
   hDane['P_461'] := sxml2num( xmlWartoscH( hPozycje, 'P_461' ) )
   hDane['P_462'] := sxml2num( xmlWartoscH( hPozycje, 'P_462' ) )
   hDane['P_463'] := sxml2num( xmlWartoscH( hPozycje, 'P_463' ) )
   hDane['P_464'] := sxml2num( xmlWartoscH( hPozycje, 'P_464' ) )
   hDane['P_465'] := sxml2num( xmlWartoscH( hPozycje, 'P_465' ) )

   hDane['P_466_1'] := iif( xmlWartoscH( hPozycje, 'P_466' ) == '1', '1', '0' )
   hDane['P_466_2'] := iif( xmlWartoscH( hPozycje, 'P_466' ) == '2', '1', '0' )

   hDane['P_467'] := sxml2num( xmlWartoscH( hPozycje, 'P_467' ) )
   hDane['P_468'] := sxml2num( xmlWartoscH( hPozycje, 'P_468' ) )
   hDane['P_469'] := sxml2num( xmlWartoscH( hPozycje, 'P_469' ) )
   hDane['P_470'] := sxml2num( xmlWartoscH( hPozycje, 'P_470' ) )
   hDane['P_471'] := sxml2num( xmlWartoscH( hPozycje, 'P_471' ) )
   hDane['P_472'] := sxml2num( xmlWartoscH( hPozycje, 'P_472' ) )
   hDane['P_473'] := sxml2num( xmlWartoscH( hPozycje, 'P_473' ) )
   hDane['P_474'] := sxml2num( xmlWartoscH( hPozycje, 'P_474' ) )
   hDane['P_475'] := sxml2num( xmlWartoscH( hPozycje, 'P_475' ) )
   hDane['P_476'] := sxml2num( xmlWartoscH( hPozycje, 'P_476' ) )
   hDane['P_477'] := sxml2num( xmlWartoscH( hPozycje, 'P_477' ) )
   hDane['P_478'] := sxml2num( xmlWartoscH( hPozycje, 'P_478' ) )
   hDane['P_479'] := sxml2num( xmlWartoscH( hPozycje, 'P_479' ) )
   hDane['P_480'] := sxml2num( xmlWartoscH( hPozycje, 'P_480' ) )
   hDane['P_481'] := sxml2num( xmlWartoscH( hPozycje, 'P_481' ) )
   hDane['P_482'] := sxml2num( xmlWartoscH( hPozycje, 'P_482' ) )
   hDane['P_483'] := sxml2num( xmlWartoscH( hPozycje, 'P_483' ) )
   hDane['P_484'] := sxml2num( xmlWartoscH( hPozycje, 'P_484' ) )
   hDane['P_485'] := sxml2num( xmlWartoscH( hPozycje, 'P_485' ) )
   hDane['P_486'] := sxml2num( xmlWartoscH( hPozycje, 'P_486' ) )
   hDane['P_487'] := sxml2num( xmlWartoscH( hPozycje, 'P_487' ) )
   hDane['P_488'] := sxml2num( xmlWartoscH( hPozycje, 'P_488' ) )
   hDane['P_489'] := sxml2num( xmlWartoscH( hPozycje, 'P_489' ) )
   hDane['P_490'] := sxml2num( xmlWartoscH( hPozycje, 'P_490' ) )
   hDane['P_491'] := sxml2num( xmlWartoscH( hPozycje, 'P_491' ) )
   hDane['P_492'] := sxml2num( xmlWartoscH( hPozycje, 'P_492' ) )
   hDane['P_493'] := sxml2num( xmlWartoscH( hPozycje, 'P_493' ) )
   hDane['P_494'] := sxml2num( xmlWartoscH( hPozycje, 'P_494' ) )
   hDane['P_495'] := sxml2num( xmlWartoscH( hPozycje, 'P_495' ) )
   hDane['P_496'] := sxml2num( xmlWartoscH( hPozycje, 'P_496' ) )
   hDane['P_497'] := sxml2num( xmlWartoscH( hPozycje, 'P_497' ) )
   hDane['P_498'] := sxml2num( xmlWartoscH( hPozycje, 'P_498' ) )
   hDane['P_499'] := sxml2num( xmlWartoscH( hPozycje, 'P_499' ) )
   hDane['P_500'] := sxml2num( xmlWartoscH( hPozycje, 'P_500' ) )
   hDane['P_501'] := sxml2num( xmlWartoscH( hPozycje, 'P_501' ) )
   hDane['P_502'] := sxml2num( xmlWartoscH( hPozycje, 'P_502' ) )

   hDane['P_503'] := iif( xmlWartoscH( hPozycje, 'P_503' ) == '1', '1', '0' )
   hDane['P_504'] := iif( xmlWartoscH( hPozycje, 'P_504' ) == '1', '1', '0' )
   hDane['P_505'] := iif( xmlWartoscH( hPozycje, 'P_505' ) == '1', '1', '0' )
   hDane['P_506'] := iif( xmlWartoscH( hPozycje, 'P_506' ) == '1', '1', '0' )
   hDane['P_507'] := iif( xmlWartoscH( hPozycje, 'P_507' ) == '1', '1', '0' )
   hDane['P_508'] := iif( xmlWartoscH( hPozycje, 'P_508' ) == '1', '1', '0' )
   hDane['P_509'] := iif( xmlWartoscH( hPozycje, 'P_509' ) == '1', '1', '0' )
   hDane['P_510'] := iif( xmlWartoscH( hPozycje, 'P_510' ) == '1', '1', '0' )
   hDane['P_511'] := iif( xmlWartoscH( hPozycje, 'P_511' ) == '1', '1', '0' )
   hDane['P_512'] := iif( xmlWartoscH( hPozycje, 'P_512' ) == '1', '1', '0' )
   hDane['P_513'] := iif( xmlWartoscH( hPozycje, 'P_513' ) == '1', '1', '0' )
   hDane['P_514'] := iif( xmlWartoscH( hPozycje, 'P_514' ) == '1', '1', '0' )
...
FUNCTION DaneXML_VAT12w4(oDoc, cNrRef, hNaglowek)
   LOCAL hPodmiot1, cTmp, hPozycje
   LOCAL hDane := hb_Hash()
   IF !HB_ISHASH( hNaglowek )
      hNaglowek := edekXmlNaglowek( oDoc )
   ...
   hDane['P_12'] := sxml2num( xmlWartoscH( hPozycje, 'P_12' ) )
   hDane['P_13'] := sxml2num( xmlWartoscH( hPozycje, 'P_13' ) )
   hDane['P_14'] := iif( xmlWartoscH( hPozycje, 'P_14' ) == '1', '1', '0' )
   hDane['P_18'] := xmlWartoscH( hPozycje, 'P_18' )
   hDane['P_19'] := xmlWartoscH( hPozycje, 'P_19' )
...
FUNCTION DaneXML_IFT2w11(oDoc, cNrRef, hNaglowek)
   LOCAL hPodmiot1, hPodmiot2, cTmp, hPozycje
   LOCAL hDane := hb_Hash()
   IF !HB_ISHASH( hNaglowek )
      hNaglowek := edekXmlNaglowek( oDoc )
   ...
   hDane['P_24'] := xmlWartoscH( hPodmiot2, 'NumerIdentyfikacyjnyPodatnika' )
   hDane['P_25'] := xmlWartoscH( hPodmiot2, 'KodKrajuWydania' )
   hDane['P_27'] := xmlWartoscH( hPodmiot2, 'KodKraju' )
   hDane['P_28'] := xmlWartoscH( hPodmiot2, 'Miejscowosc' )
   hDane['P_29'] := xmlWartoscH( hPodmiot2, 'KodPocztowy' )
   hDane['P_30'] := xmlWartoscH( hPodmiot2, 'Ulica' )
   hDane['P_31'] := xmlWartoscH( hPodmiot2, 'NrDomu' )
   hDane['P_32'] := xmlWartoscH( hPodmiot2, 'NrLokalu' )

   hDane['P_26'] := xmlWartoscH( hPozycje, 'P_26' )
   hDane['P_26_1'] := iif( hDane[ 'P_26' ] == '1', '1', '0' )
   hDane['P_26_2'] := iif( hDane[ 'P_26' ] == '2', '1', '0' )

   hDane['P_33'] := sxml2num( xmlWartoscH( hPozycje, 'P_33' ) )
   hDane['P_34'] := sxml2num( xmlWartoscH( hPozycje, 'P_34' ) )
   hDane['P_35'] := sxml2num( xmlWartoscH( hPozycje, 'P_35' ) )
   hDane['P_E1'] := sxml2num( xmlWartoscH( hPozycje, 'P_E1' ) )
   ...
   hDane['P_37'] := sxml2num( xmlWartoscH( hPozycje, 'P_37' ) )
   hDane['P_38'] := sxml2num( xmlWartoscH( hPozycje, 'P_38' ) )
   hDane['P_F1'] := sxml2num( xmlWartoscH( hPozycje, 'P_F1' ) )
   ...
   hDane['P_40'] := sxml2num( xmlWartoscH( hPozycje, 'P_40' ) )
   hDane['P_41'] := sxml2num( xmlWartoscH( hPozycje, 'P_41' ) )
   hDane['P_G1'] := sxml2num( xmlWartoscH( hPozycje, 'P_G1' ) )
   ...
   hDane['P_43'] := sxml2num( xmlWartoscH( hPozycje, 'P_43' ) )
   hDane['P_44'] := sxml2num( xmlWartoscH( hPozycje, 'P_44' ) )
   hDane['P_H1'] := sxml2num( xmlWartoscH( hPozycje, 'P_H1' ) )
   ...
   hDane['P_46'] := sxml2num( xmlWartoscH( hPozycje, 'P_46' ) )
   hDane['P_47'] := sxml2num( xmlWartoscH( hPozycje, 'P_47' ) )
   hDane['P_I1'] := sxml2num( xmlWartoscH( hPozycje, 'P_I1' ) )
   ...
   hDane['P_49'] := sxml2num( xmlWartoscH( hPozycje, 'P_49' ) )
   hDane['P_50'] := sxml2num( xmlWartoscH( hPozycje, 'P_50' ) )
   hDane['P_J1'] := sxml2num( xmlWartoscH( hPozycje, 'P_J1' ) )
   ...
   hDane['P_52'] := sxml2num( xmlWartoscH( hPozycje, 'P_52' ) )
   hDane['P_53'] := sxml2num( xmlWartoscH( hPozycje, 'P_53' ) )
   hDane['P_K1'] := sxml2num( xmlWartoscH( hPozycje, 'P_K1' ) )
   ...
   hDane['P_56'] := sxml2num( xmlWartoscH( hPozycje, 'P_56' ) )
   hDane['P_57'] := sxml2num( xmlWartoscH( hPozycje, 'P_57' ) )
   hDane['P_L1'] := sxml2num( xmlWartoscH( hPozycje, 'P_L1' ) )
   hDane['P_L2'] := sxml2num( xmlWartoscH( hPozycje, 'P_L2' ) )
   ...
   hDane['P_60'] := sxml2num( xmlWartoscH( hPozycje, 'P_60' ) )
   hDane['P_61'] := sxml2num( xmlWartoscH( hPozycje, 'P_61' ) )
   hDane['P_M1'] := sxml2num( xmlWartoscH( hPozycje, 'P_M1' ) )
   hDane['P_M2'] := sxml2num( xmlWartoscH( hPozycje, 'P_M2' ) )
   ...
   hDane['P_64'] := sxml2num( xmlWartoscH( hPozycje, 'P_64' ) )
   hDane['P_65'] := sxml2num( xmlWartoscH( hPozycje, 'P_65' ) )
   hDane['P_N1'] := sxml2num( xmlWartoscH( hPozycje, 'P_N1' ) )
   hDane['P_N2'] := sxml2num( xmlWartoscH( hPozycje, 'P_N2' ) )
   ...
   hDane['P_67'] := sxml2num( xmlWartoscH( hPozycje, 'P_67' ) )
   hDane['P_68'] := sxml2num( xmlWartoscH( hPozycje, 'P_68' ) )
   hDane['P_O1'] := sxml2num( xmlWartoscH( hPozycje, 'P_O1' ) )
   ...
   hDane['P_118'] := xml2date( xmlWartoscH( hPozycje, 'P_118' ), '' )
   hDane['P_119'] := xml2date( xmlWartoscH( hPozycje, 'P_119' ), '' )
...
FUNCTION DaneXML_IFT2w12(oDoc, cNrRef, hNaglowek)
   LOCAL hPodmiot1, hPodmiot2, cTmp, hPozycje
   LOCAL hDane := hb_Hash()
   IF !HB_ISHASH( hNaglowek )
      hNaglowek := edekXmlNaglowek( oDoc )
   ...
   hDane['P_70'] := sxml2num( xmlWartoscH( hPozycje, 'P_70' ) )
   hDane['P_71'] := sxml2num( xmlWartoscH( hPozycje, 'P_71' ) )
   hDane['P_P1'] := sxml2num( xmlWartoscH( hPozycje, 'P_P1' ) )
   hDane['P_P2'] := sxml2num( xmlWartoscH( hPozycje, 'P_P2' ) )
   hDane['P_P3'] := sxml2num( xmlWartoscH( hPozycje, 'P_P3' ) )
   hDane['P_P4'] := sxml2num( xmlWartoscH( hPozycje, 'P_P4' ) )
   hDane[ 'PP' ] := { { 'aktywny' => iif( ! Empty( hDane[ 'P_P1' ] ) .OR. ! Empty( hDane[ 'P_P2' ] ) .OR. ! Empty( hDane[ 'P_P3' ] ) .OR. ! Empty( hDane[ 'P_P4' ] ), 1, 0 ), ;
      'P_P1' => hDane[ 'P_P1' ], ;
      'P_P2' => hDane[ 'P_P2' ], ;
      'P_P3' => hDane[ 'P_P3' ], ;
      'P_P4' => hDane[ 'P_P4' ] } }
   ...
   hDane['P_121'] := xml2date( xmlWartoscH( hPozycje, 'P_121' ), '' )
   hDane['P_122'] := xml2date( xmlWartoscH( hPozycje, 'P_122' ), '' )
...
FUNCTION DaneXML_JPKV7w3( oDoc, cNrRef, hNaglowek )
   ...
   IF Len( hDane[ 'Sprzedaz' ] ) > 0
      ...
      AEval( hDane[ 'Sprzedaz' ], { | aPoz |
         aPoz[ 'KodKrajuNadaniaTIN' ] := xmlWartoscH( aPoz, 'KodKrajuNadaniaTIN' )
         aPoz[ 'TypDokumentu' ] := xmlWartoscH( aPoz, 'TypDokumentu' )
         aPoz[ 'NrKSeF' ] := xmlWartoscH( aPoz, 'NrKSeF' )
         IF Empty( aPoz[ 'NrKSeF' ] )
            IF xmlWartoscH( aPoz, 'OFF' ) == '1'
               aPoz[ 'NrKSeF' ] := 'OFF'
            ELSEIF xmlWartoscH( aPoz, 'BFK' ) == '1'
               aPoz[ 'NrKSeF' ] := 'BFK'
            ELSEIF xmlWartoscH( aPoz, 'DI' ) == '1'
               aPoz[ 'NrKSeF' ] := 'DI'
            ELSE
               aPoz[ 'NrKSeF' ] := ''
            ENDIF
         ...
         aPoz[ 'K_35' ] := sxml2num( xmlWartoscH( aPoz, 'K_35' ), 0 )
         aPoz[ 'K_36' ] := sxml2num( xmlWartoscH( aPoz, 'K_36' ), 0 )
         aPoz[ 'K_360' ] := sxml2num( xmlWartoscH( aPoz, 'K_360' ), 0 )
         aPoz[ 'SprzedazVAT_Marza' ] := sxml2num( xmlWartoscH( aPoz, 'SprzedazVAT_Marza' ), 0 )
         IF ! hb_HHasKey( aPoz, 'DataSprzedazy' )
            aPoz[ 'DataSprzedazy' ] := ""
         ENDIF
