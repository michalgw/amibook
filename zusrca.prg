         ...
         IF DOD .AND. DDO = .T.
            ...
            IF Found()
               ddorca( PRAC->NAZWISKO,;
                  ...
                  ETATY->PENSJA - ETATY->DOPL_BZUS - ETATY->ZASI_BZUS - ETATY->RYCZ_SAM, ;
                  ETATY->PENSJA - ETATY->DOPL_BZUS - ETATY->ZASI_BZUS - ETATY->RYCZ_SAM, ;
                  ETATY->BRUT_RAZEM - ( ETATY->DOPL_BZUS + ETATY->ZASI_BZUS + ETATY->WAR_PF3 + ETATY->WAR_PSUM + ETATY->RYCZ_SAM ), ;
                  ETATY->PENSJA - ETATY->DOPL_BZUS - ETATY->ZASI_BZUS - ETATY->RYCZ_SAM, ;
                  ETATY->WAR_PUE, ;
                  ETATY->WAR_PUR, ;
                  ETATY->WAR_PUC, ;
