...
PROCEDURE Vat_719( _G, _M, _STR, _OU )
...
*        ColStd()
         ...
         @  3, 70 GET kordek PICTURE '!' WHEN wfkordek19( 3, 71 ) VALID vfkordek19( 3, 71 )
         IF zVATFORDR == '7D'
   ...
   *             endif
      ...
      CASE _OU == 'K'
         ...
         CASE 1
            SWITCH zVATFORDR
            CASE '7 '
               DeklarDrukuj( 'VAT7-19' )
               EXIT
            CASE '7K'
               DeklarDrukuj( 'VAT7K-13' )
               EXIT
            CASE '7D'
...
//         IF ValType( tresc_korekty_vat7 ) == "C"
            ...
            DO CASE
            CASE zVATFORDR == '7 '
               resdekl := edek_vat7_19( aDane )
               edekZapiszXml( resdekl, edeklaracja_plik, wys_edeklaracja, 'VAT7-19', kordek == 'K', Val( miesiac ) )
            CASE zVATFORDR == '7K'
               resdekl := edek_vat7k_13( aDane )
               edekZapiszXml( resdekl, edeklaracja_plik, wys_edeklaracja, 'VAT7K-13', kordek == 'K', Val( miesiac ) )
            CASE zVATFORDR == '7D'
