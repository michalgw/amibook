...
PROCEDURE Tab_Doch()
   ...
   *################################# GRAFIKA ##################################
   @  3,  42 CLEAR TO 22, 79
   @  5,  33 CLEAR TO 20, 79
   @  6,  36 SAY 'ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»'
   @  7,  36 SAY 'º Podstawa ³ Podatek ³   Data   ³   Data   º'
   @  8,  36 SAY 'ºopodatkow.³    %    ³    od    ³    do    º'
   @  9,  36 SAY 'ºÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄº'
   @ 10,  36 SAY 'º          ³         ³          ³          º'
   @ 11,  36 SAY 'º          ³         ³          ³          º'
   @ 12,  36 SAY 'º          ³         ³          ³          º'
   @ 13,  36 SAY 'º          ³         ³          ³          º'
   ...
   @ 17,  36 SAY 'º          ³         ³          ³          º'
   @ 18,  36 SAY 'º          ³         ³          ³          º'
   @ 19,  36 SAY 'ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼'
...
FUNCTION linia2()
   ...
   RETURN kwota( PODSTAWA, 10, 2 ) + "³  " + Str( PROCENT, 5, 2 ) + "  ³" +  DToC( dataod ) + "³" +  DToC( datado )
