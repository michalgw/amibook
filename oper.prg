   ...
   DO WHILE kl # K_ESC
      ...
      *########################### INSERT/MODYFIKACJA #############################
      ...
      CASE kl == Asc( 'I' ) .OR. kl == Asc( 'i' )
         // Import z JPK
         nMenu := MenuEx( 18, 25, { "K - Importuj sprzeda¾ z programu GM Kos", "Z - Importuj zakupy z programu GM Kos", "F - Import z pliku JPK_FA, JPK_V7", "P - Import z pliku JPK_PKPIR" }, 1 )
         DO CASE
         CASE nMenu == 1
            JPKImp_VatS( 2, .T. )
         CASE nMenu == 2
