...
begin sequence
      ...
      *@@@@@@@@@@@@@@@@@@@@@@@@@@ ZAKRES @@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      ...
      @ 21,21 say [Od kontrahenta] get od_kontr picture repl('!',40)
      ...
      *@@@@@@@@@@@@@@@@@@@@@@@@@ NAGLOWEK @@@@@@@@@@@@@@@@@@@@@@@@@@@@
      ...
      k1=dtoc(od_dnia)
      k2=dtoc(do_dnia)
      mon_drk([ ZESTAWIENIE OBROT&__O.W Z KONTRAHENTEM   za okres od  ]+k1+[  do  ]+k2)
      ...
      *@@@@@@@@@@@@@@@@@@@@ OTWARCIE BAZ DANYCH @@@@@@@@@@@@@@@@@@@@@@
      ...
      if zRYCZALT<>'T'.and.dostepex('OPER')
         index on del+firma+iif(strtran(mc+[.]+dzien,' ','0')>=od_dnia_.and.strtran(mc+[.]+dzien,' ','0')<=do_dnia_,[+],[-])+substr(nazwa,1,15)+substr(adres,1,15)+mc+dzien to &raptemp
         if dostep('OPER')
            set inde to &raptemp
               ...
               do while .not.&_koniec
                  if substr(numer,1,3)<>'RZ-' .and. substr(numer,1,3)<>'RS-'
                     ...
                     *@@@@@@@@@@@@@@@@@@@@@@ MODUL OBLICZEN @@@@@@@@@@@@@@@@@@@@@@@@@
                     ...
                     k3a=SubStr( iif(left(numer,1)=chr(1).or.left(numer,1)=chr(254),substr(numer,2)+[ ],numer), 1, 10 )
                     if WYR_tow+USLUGI>0
