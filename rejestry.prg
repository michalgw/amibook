...
*################################# GRAFIKA ##################################
@  3, 0 clear to 22,79
@  4, 0 say padc('KATALOG  NAZW  REJESTR&__O.W  DZIA&__L.ALNO&__S.CI  GOSPODARCZEJ',80)
@  5, 8 say '                                                              '
@  6, 8 say '                         Nazwa Rejestru                       '
@  7, 8 say 'ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿'
@  8, 8 say '³                                                            ³'
@  9, 8 say '³                                                            ³'
@ 10, 8 say '³                                                            ³'
@ 11, 8 say '³                                                            ³'
...
@ 20, 8 say '³                                                            ³'
@ 21, 8 say '³                                                            ³'
@ 22, 8 say 'ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ'
*############################### OTWARCIE BAZ ###############################
select 2
...
do while kl#27
   ...
   ColStd()
        ...
        do while .t.
           ...
           *ðððððððððððððððððððððððððððððððð GET ðððððððððððððððððððððððððððððððððð
           @ wiersz,9 get zNAZWA_REJ picture repl('!',60) valid v151_1()
           read_()
           if lastkey()=27
              exit
           endif
   ...
   *################################ KASOWANIE #################################
   ...
   ColStd()
           ...
           kom(3,[*u],[ Kasowanie niemo&_z.liwe. S&_a. firmy przypisane do tego rejestru ])
           keyboard chr(27)
           inkey()
        endif
        sele rejestry
