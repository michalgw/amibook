...
PROCEDURE Param_PPla()
   ...
   *################################# GRAFIKA ##################################
   @  3,  12 CLEAR TO 22, 79
   @  6,  13 SAY 'ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»'
   @  7,  13 SAY 'º   Data   ³ Podatek ³Odlicz od ³Obni¾ zdro³ Ulga dla ³Przes.termº'
   @  8,  13 SAY 'º    od    ³    %    ³ podatku  ³ do 2021  ³ kl. ˜red.³pob.zaliczº'
   @  9,  13 SAY 'ºÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄº'
   @ 10,  13 SAY 'º          ³         ³          ³          ³          ³          º'
   @ 11,  13 SAY 'º          ³         ³          ³          ³          ³          º'
   @ 12,  13 SAY 'º          ³         ³          ³          ³          ³          º'
   @ 13,  13 SAY 'º          ³         ³          ³          ³          ³          º'
   ...
   @ 17,  13 SAY 'º          ³         ³          ³          ³          ³          º'
   @ 18,  13 SAY 'º          ³         ³          ³          ³          ³          º'
   @ 19,  13 SAY 'ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼'
